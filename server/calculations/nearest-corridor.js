...
exports.findNearestCorridorPoint = findNearestCorridorPoint;
 ...
 */
function findNearestCorridorPoint(location, corridors) {
  ...
  for (const corridor of corridors) {
    ...
    for (let i = 0; i < points.length; i++) {
      ...
      const dist = (0, _haversine.haversineMetres)(location.lat, location.lng, point.lat, point.lng);
      if (dist < minDistance) {
        minDistance = dist;
