var _nearestCorridor = require("../../calculations/nearest-corridor.js");
describe('findNearestCorridorPoint', () => {
  ...
  it('returns null for an empty corridor list', () => {
    expect((0, _nearestCorridor.findNearestCorridorPoint)(location, [])).toBeNull();
  });
  it('returns null for invalid inputs', () => {
    expect((0, _nearestCorridor.findNearestCorridorPoint)(location, null)).toBeNull();
    expect((0, _nearestCorridor.findNearestCorridorPoint)(location, undefined)).toBeNull();
    expect((0, _nearestCorridor.findNearestCorridorPoint)(location, 'not-an-array')).toBeNull();
  });
  it('returns the nearest point for a single corridor', () => {
    ...
    const result = (0, _nearestCorridor.findNearestCorridorPoint)(location, corridors);
  ...
  it('returns null if all corridors are malformed', () => {
    ...
    expect((0, _nearestCorridor.findNearestCorridorPoint)(location, corridors)).toBeNull();
  });
});