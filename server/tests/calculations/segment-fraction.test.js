import { calculateUserSegmentFraction } from '../../calculations/segment-fraction.js';
import { TopologyError } from '../../utils/errors.js';
...
describe('calculateUserSegmentFraction', () => {
    it('returns 0 for zero-length corridor', () => {
        ...
        const result = calculateUserSegmentFraction(topology, 0);
    ...
    it('returns exact fraction for a middle point', () => {
        ...
        const result = calculateUserSegmentFraction(topology, 1);
    ...
    it('returns 1 for the last point', () => {
        ...
        const result = calculateUserSegmentFraction(topology, 2);
    ...
    it('throws TopologyError for an invalid negative index', () => {
        ...
        expect(() => calculateUserSegmentFraction(topology, -1)).toThrow(TopologyError);
    });
    ...
    it('throws TopologyError for an invalid large index', () => {
        ...
        expect(() => calculateUserSegmentFraction(topology, 3)).toThrow(TopologyError);
    });
    ...
    it('throws TopologyError for non-integer index', () => {
        ...
        expect(() => calculateUserSegmentFraction(topology, 1.5)).toThrow(TopologyError);
    });
});
